...
namespace cshort {
    ...
    */
    ...
    static CodeLine *appendToLine_BoolNode(ConstLiteralTokenStruct *self, CodeLine *currentCodeLine) {
        return currentCodeLine->AddAttachedFormatTokens(self)->appendToken(self);
    }

    static void copySelfText_BoolNode(ConstLiteralTokenStruct *self, utf8byte *buf) {
        TEXT_MEMCPY(buf, self->text, self->textLength);
    }

    static int selfTextLength_BoolNode(ConstLiteralTokenStruct *self) {
    ...
    static constexpr const char boolNodeTypeText[] = "<const literal>";
    static token_vtable _boolVTable = CREATE_TOKEN_VTABLE(ConstLiteralTokenStruct,
                                                   selfTextLength_BoolNode,
                                                   copySelfText_BoolNode, appendToLine_BoolNode,
                                                   ConstLiteralTokenStruct_applyFuncToDescendants,
                                                   boolNodeTypeText, TokenTypeId::ConstLiteral);

    const token_vtable *VTables::ConstLiteralVTable = &_boolVTable;
